...
//
void InitEPwm5Gpio(void)    //这里仅用EPWM5A作为DAB原边半桥驱动，故屏蔽5B
{
    EALLOW;
    //
    // Disable internal pull-up for the selected output pins
...
void InitEPwm9Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAPUD.bit.GPIO16 = 1;    // Disable pull-up on GPIO165 (EPWM11A)
    GpioCtrlRegs.GPAPUD.bit.GPIO17 = 1;    // Disable pull-up on GPIO166 (EPWM11B)
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 1;   // Configure GPIO161 as EPWM9A
    GpioCtrlRegs.GPAMUX2.bit.GPIO17 = 1;   // Configure GPIO162 as EPWM9B
    GpioCtrlRegs.GPAGMUX2.bit.GPIO16 = 1;   // Configure GPIO161 as EPWM9A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO17 = 1;   // Configure GPIO162 as EPWM9B
...
void InitEPwm11Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAMUX2.bit.GPIO20 = 1;   // Configure GPIO165 as EPWM11A
    GpioCtrlRegs.GPAMUX2.bit.GPIO21 = 1;   // Configure GPIO166 as EPWM11B

    GpioCtrlRegs.GPAGMUX2.bit.GPIO20 = 1;   // Configure GPIO165 as EPWM11A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO21 = 1;   // Configure GPIO166 as EPWM11B
...
void InitEPwm12Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAMUX2.bit.GPIO22 = 1;   // Configure GPIO167 as EPWM12A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO22 = 1;   // Configure GPIO167 as EPWM12A

    GpioCtrlRegs.GPAMUX2.bit.GPIO23 = 1;   // Configure GPIO167 as EPWM12A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO23 = 1;   // Configure GPIO167 as EPWM12A
